...
with col[1]:
    ...
    line_chart = make_line_chart(df_reshaped,'year_month','money', color='coffee_name', color_scheme=selected_color_theme, title="Total Sales by Coffee Type Over Time")
